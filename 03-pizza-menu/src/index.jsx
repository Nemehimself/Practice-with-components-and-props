...
function Footer() {
  ...
  console.log(isOpen);
  // if (!isOpen) alert("We're currently closed");
  ...
  return (
    <footer className="footer">
      {isOpen ? (
        ...
        <p>
          We&apos;re currently closed, please check back from {openHour}:00 to{" "}
          {closeHour}:00
        </p>
      )}
...
// Add the missing 'closeHour' prop to the props validation
Order.propTypes = {
